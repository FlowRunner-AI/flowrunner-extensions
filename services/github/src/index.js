...
class GitHub {
  ...
  /**
     ...
     * @paramDef {"type":"String","label":"State","name":"state","description":"State of the issue.","uiComponent":{"type":"DROPDOWN","options":[{"label":"Open","value":"open"},{"label":"Closed","value":"closed"}]}}
     * @paramDef {"type":"String","label":"Assignees","name":"assignees","description":"Logins of users to assign to this issue. Pass as comma-separated string.","dictionary":"getUsersDictionary"}
     * @paramDef {"type":"String","label":"Milestone","name":"milestone","description":"The number of the milestone to associate this issue with.","dictionary":"getMilestonesDictionary","dependsOn":["repository"]}
     * @paramDef {"type":"String","label":"Labels","name":"labels","description":"Labels to apply to this issue. Pass as comma-separated string.","dictionary":"getLabelsDictionary","dependsOn":["repository"]}
     *
  ...
  /**
     ...
     * @paramDef {"type":"String","label":"Visibility","name":"visibility","description":"Can be 'public', 'private', or 'internal'. Default: 'public'.","uiComponent":{"type":"DROPDOWN","options":[{"label":"Public","value":"public"},{"label":"Private","value":"private"},{"label":"Internal","value":"internal"}]}}
     *
     * @returns {Object}
  ...
  /**
     ...
     * @paramDef {"type":"String","label":"Merge Method","name":"merge_method","description":"Merge method to use.","defaultValue":"merge","uiComponent":{"type":"DROPDOWN","options":[{"label":"Merge","value":"merge"},{"label":"Squash","value":"squash"},{"label":"Rebase","value":"rebase"}]}}
     *
     * @returns {Object}
  ...
  /**
     ...
     * @paramDef {"type":"String","label":"Permission","name":"permission","description":"The permission to grant the collaborator. Default: 'pull'.","uiComponent":{"type":"DROPDOWN","options":[{"label":"Read","value":"pull"},{"label":"Triage","value":"triage"},{"label":"Write","value":"push"},{"label":"Maintain","value":"maintain"},{"label":"Admin","value":"admin"}]}}
     *
     * @returns {Object}
  ...
  /**
     ...
     * @paramDef {"type":"String","label":"Config Content Type","name":"config_content_type","description":"The media type used to serialize the payloads. Default: 'json'.","uiComponent":{"type":"DROPDOWN","options":[{"label":"JSON","value":"json"},{"label":"Form (application/x-www-form-urlencoded)","value":"form"}]}}
  ...
  /**
     ...
     * @paramDef {"type":"String","label":"Privacy","name":"privacy","description":"The level of privacy for the team. Default: 'secret'.","uiComponent":{"type":"DROPDOWN","options":[{"label":"Secret","value":"secret"},{"label":"Closed","value":"closed"}]}}
  ...
  /**
     ...
     * @paramDef {"type":"String","label":"Role","name":"role","description":"The role that the user will have in the team. Default: 'member'.","uiComponent":{"type":"DROPDOWN","options":[{"label":"Member","value":"member"},{"label":"Maintainer","value":"maintainer"}]}}
     *
     * @returns {Object}
  ...
  /**
     ...
     * @paramDef {"type":"String","label":"Team Slug","name":"team_slug","required":true,"description":"The slug of the team.","dictionary":"getTeamsDictionary","dependsOn":["org"]}
     * @paramDef {"type":"String","label":"Repository","name":"repository","required":true,"description":"Repository in format owner/repo","dictionary":"getRepositoriesDictionary"}
     * @paramDef {"type":"String","label":"Permission","name":"permission","description":"The permission to grant the team on this repository. Default: 'pull'.","uiComponent":{"type":"DROPDOWN","options":[{"label":"Read","value":"pull"},{"label":"Triage","value":"triage"},{"label":"Write","value":"push"},{"label":"Maintain","value":"maintain"},{"label":"Admin","value":"admin"}]}}
     *
     * @returns {Object}
  ...
  /**
     ...
     *
     * @paramDef {"type":"String","label":"Repository","name":"repository","required":true,"description":"Repository in format owner/repo","dictionary":"getRepositoriesDictionary"}
     * @paramDef {"type":"String","label":"Subscribed State","name":"subscribed","required":true,"description":"Describes the level of subscription. 'true' to subscribe to all notifications, 'false' to ignore all notifications.","uiComponent":{"type":"DROPDOWN","options":[{"label":"Subscribed","value":"true"},{"label":"Ignored","value":"false"}]}}
     *
     * @returns {Object}
  ...
  /**
     ...
     * @paramDef {"type":"String","label":"State","name":"state","description":"The state of the milestone.","defaultValue":"open","uiComponent":{"type":"DROPDOWN","options":[{"label":"Open","value":"open"},{"label":"Closed","value":"closed"}]}}
  ...
  /**
     ...
     * @paramDef {"type":"String","label":"Title","name":"title","description":"The title of the milestone."}
        * @paramDef {"type":"String","label":"State","name":"state","description":"The state of the milestone.","uiComponent":{"type":"DROPDOWN","options":[{"label":"Open","value":"open"},{"label":"Closed","value":"closed"}]}}
     * @paramDef {"type":"String","label":"Description","name":"description","description":"A short description of the milestone.","uiComponent":{"type":"MULTI_LINE_TEXT"}}
     * @paramDef {"type":"String","label":"Due On","name":"due_on","description":"The milestone due date in ISO 8601 format: YYYY-MM-DDTHH:MM:SSZ."}
     *
     * @returns {Object}
  ...
  /**
     ...
     * @paramDef {"type":"String","label":"Category Name","name":"category_name","required":true,"description":"The name of the discussion category.","uiComponent":{"type":"DROPDOWN","options":[{"label":"Announcements","value":"Announcements"},{"label":"General","value":"General"},{"label":"Ideas","value":"Ideas"},{"label":"Q&A","value":"Q&A"},{"label":"Show and Tell","value":"Show and Tell"}]}}
     *
     * @returns {Object}
  ...
  /**
     ...
     * @paramDef {"type":"String","label":"Visibility","name":"visibility","description":"The visibility of the secret. Default: 'private'.","uiComponent":{"type":"DROPDOWN","options":[{"label":"All Repositories","value":"all"},{"label":"Private Repositories","value":"private"},{"label":"Selected Repositories","value":"selected"}]}}
  ...
  /**
     ...
     * @paramDef {"type":"String","label":"Variable Name","name":"name","required":true,"description":"The name of the variable."}
     * @paramDef {"type":"String","label":"Value","name":"value","required":true,"description":"The value of the variable.","uiComponent":{"type":"MULTI_LINE_TEXT"}}
     * @paramDef {"type":"String","label":"Visibility","name":"visibility","description":"The visibility of the variable. Default: 'private'.","uiComponent":{"type":"DROPDOWN","options":[{"label":"All Repositories","value":"all"},{"label":"Private Repositories","value":"private"},{"label":"Selected Repositories","value":"selected"}]}}
  ...
  /**
     ...
     * @paramDef {"type":"String","label":"Status","name":"status","description":"Returns runs with the check run status or conclusion specified."}
