...
const logger = {
  info: (...args) => console.log('[Backendless Cloud Code Service] info:', ...args),
  debug: (...args) => console.log('[Backendless Cloud Code Service] debug:', ...args),
  error: (...args) => console.log('[Backendless Cloud Code Service] error:', ...args),
  warn: (...args) => console.log('[Backendless Cloud Code Service] warn:', ...args),
}
...
/**
 *  @requireOAuth
 *  @integrationName Backendless Cloud Code Service
 *  @integrationTriggersScope SINGLE_APP
 *  @integrationIcon /icon.png
 **/
class BackendlessCloudCodeService {
  constructor(config) {
...
Flowrunner.ServerCode.addService(BackendlessCloudCodeService, [
  {
